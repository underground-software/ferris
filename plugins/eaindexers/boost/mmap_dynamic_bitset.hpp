...
//  See http://www.boost.org/libs/mmap_dynamic_bitset/ for documentation.
//
//  $Revision: 1.1 $ $Date: 2009/01/31 11:21:57 $ - $Name:  $


#ifndef BOOST_MMAP_DYNAMIC_BITSET_MMAP_DYNAMIC_BITSET_HPP
#define BOOST_MMAP_DYNAMIC_BITSET_MMAP_DYNAMIC_BITSET_HPP
...
public:
    ...
    class reference
    {
        friend class mmap_dynamic_bitset<Block, Allocator>;
    ...
    // constructors, etc.
    explicit
    mmap_dynamic_bitset(const Allocator& alloc = Allocator());

    explicit
    mmap_dynamic_bitset(size_type num_bits, unsigned long value = 0,
    ...
    mmap_dynamic_bitset(const std::basic_string<CharT, Traits, Alloc>& s,
    ...
    mmap_dynamic_bitset(BlockInputIterator first, BlockInputIterator last,
                   const Allocator& alloc = Allocator())
    ...
    // copy constructor
    mmap_dynamic_bitset(const mmap_dynamic_bitset& b);

    ~mmap_dynamic_bitset();

    void swap(mmap_dynamic_bitset& b);
    mmap_dynamic_bitset& operator=(const mmap_dynamic_bitset& b);
    ...
    {
        boost::interprocess::vector<Block, Allocator> v(first, last);
    ...
    mmap_dynamic_bitset& operator^=(const mmap_dynamic_bitset& b);
    mmap_dynamic_bitset& operator-=(const mmap_dynamic_bitset& b);
    mmap_dynamic_bitset& operator<<=(size_type n);
    mmap_dynamic_bitset& operator>>=(size_type n);
    mmap_dynamic_bitset operator<<(size_type n) const;
    mmap_dynamic_bitset operator>>(size_type n) const;

    // basic bit operations
    mmap_dynamic_bitset& set(size_type n, bool val = true);
    mmap_dynamic_bitset& set();
    mmap_dynamic_bitset& reset(size_type n);
    mmap_dynamic_bitset& reset();
    mmap_dynamic_bitset& flip(size_type n);
    mmap_dynamic_bitset& flip();
    bool test(size_type n) const;
    bool any() const;
    bool none() const;
    mmap_dynamic_bitset operator~() const;
    ...
    bool is_subset_of(const mmap_dynamic_bitset& a) const;
    bool is_proper_subset_of(const mmap_dynamic_bitset& a) const;
    bool intersects(const mmap_dynamic_bitset & a) const;
...
#if !defined BOOST_MMAP_DYNAMIC_BITSET_DONT_USE_FRIENDS
    // lexicographical comparison
    template <typename B, typename A>
    friend bool operator==(const mmap_dynamic_bitset<B, A>& a,
                           const mmap_dynamic_bitset<B, A>& b);
    ...
    friend void to_block_range(const mmap_dynamic_bitset<B, A>& b,
                               BlockOutputIterator result);

    template <typename BlockIterator, typename B, typename A>
    friend void from_block_range(BlockIterator first, BlockIterator last,
                                 mmap_dynamic_bitset<B, A>& result);


    template <typename CharT, typename Traits, typename B, typename A>
    friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is,
                                                         mmap_dynamic_bitset<B, A>& b);

    template <typename B, typename A, typename stringT>
    friend void to_string_helper(const mmap_dynamic_bitset<B, A> & b, stringT & s, bool dump_all);
...
private:
    ...
    typedef boost::interprocess::vector<block_type, allocator_type> buffer_type;
...
bool m_unchecked_test(size_type pos) const;
    ...
    class bit_appender {
      ...
      // client code everything works *as if* mmap_dynamic_bitset<> had
      ...
      //
      mmap_dynamic_bitset & bs;
      size_type n;
      Block mask;
      Block * current;
    public:
        bit_appender(mmap_dynamic_bitset & r) : bs(r), n(0), mask(0), current(0) {}
        ~bit_appender() {
...
mmap_dynamic_bitset<Block, Allocator>::block_width_type const
mmap_dynamic_bitset<Block, Allocator>::bits_per_block;

template<typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>::block_width_type const
mmap_dynamic_bitset<Block, Allocator>::ulong_width;
...
// comparison
template <typename Block, typename Allocator>
bool operator!=(const mmap_dynamic_bitset<Block, Allocator>& a,
                const mmap_dynamic_bitset<Block, Allocator>& b);
...
template <typename Block, typename Allocator>
std::istream& operator>>(std::istream& is, mmap_dynamic_bitset<Block,Allocator>& b);
#else
...
operator>>(std::basic_istream<CharT, Traits>& is,
           mmap_dynamic_bitset<Block, Allocator>& b);
#endif

// bitset operations
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>
operator&(const mmap_dynamic_bitset<Block, Allocator>& b1,
          const mmap_dynamic_bitset<Block, Allocator>& b2);
...
template<typename Block, typename Allocator>
void swap(mmap_dynamic_bitset<Block, Allocator>& b1,
          mmap_dynamic_bitset<Block, Allocator>& b2);


template <typename Block, typename Allocator, typename stringT>
void
to_string(const mmap_dynamic_bitset<Block, Allocator>& b, stringT & s);

template <typename Block, typename Allocator, typename BlockOutputIterator>
void
to_block_range(const mmap_dynamic_bitset<Block, Allocator>& b,
               BlockOutputIterator result);
...
//=============================================================================
// mmap_dynamic_bitset implementation
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>::mmap_dynamic_bitset(const Allocator& alloc)
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>::
mmap_dynamic_bitset(size_type num_bits, unsigned long value, const Allocator& alloc)
...
// copy constructor
template <typename Block, typename Allocator>
inline mmap_dynamic_bitset<Block, Allocator>::
mmap_dynamic_bitset(const mmap_dynamic_bitset& b)
...
template <typename Block, typename Allocator>
inline void mmap_dynamic_bitset<Block, Allocator>::
swap(mmap_dynamic_bitset<Block, Allocator>& b) // no throw
{
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>& mmap_dynamic_bitset<Block, Allocator>::
operator=(const mmap_dynamic_bitset<Block, Allocator>& b)
{
    m_bits = b.m_bits;
...
template <typename Block, typename Allocator>
inline typename mmap_dynamic_bitset<Block, Allocator>::allocator_type
mmap_dynamic_bitset<Block, Allocator>::get_allocator() const
{
...
template <typename Block, typename Allocator>
void mmap_dynamic_bitset<Block, Allocator>::
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::operator&=(const mmap_dynamic_bitset& rhs)
{
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::operator<<=(size_type n)
{
    if (n >= m_num_bits)
        return reset();
    //else
    ...
    // headers before mmap_dynamic_bitset, he will still get the warning.
...
//
template <typename B, typename A>
mmap_dynamic_bitset<B, A> & mmap_dynamic_bitset<B, A>::operator>>=(size_type n) {
    if (n >= m_num_bits) {
        return reset();
    }
    //else
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>
mmap_dynamic_bitset<Block, Allocator>::operator<<(size_type n) const
{
    mmap_dynamic_bitset r(*this);
    return r <<= n;
}
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::set(size_type pos, bool val)
{
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::set()
{
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::reset(size_type pos)
{
    assert(pos < m_num_bits);
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::reset()
{
  std::fill(m_bits.begin(), m_bits.end(), Block(0));
  return *this;
}
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::flip(size_type pos)
{
    assert(pos < m_num_bits);
    m_bits[block_index(pos)] ^= bit_mask(pos);
    return *this;
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>&
mmap_dynamic_bitset<Block, Allocator>::flip()
{
    for (size_type i = 0; i < num_blocks(); ++i)
        m_bits[i] = ~m_bits[i];
    m_zero_unused_bits();
...
template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::m_unchecked_test(size_type pos) const
{
    return (m_bits[block_index(pos)] & bit_mask(pos)) != 0;
}

template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::test(size_type pos) const
{
    assert(pos < m_num_bits);
...
template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::any() const
{
    for (size_type i = 0; i < num_blocks(); ++i)
        if (m_bits[i])
            return true;
...
template <typename Block, typename Allocator>
inline bool mmap_dynamic_bitset<Block, Allocator>::none() const
{
    return !any();
}
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>
mmap_dynamic_bitset<Block, Allocator>::operator~() const
{
    mmap_dynamic_bitset b(*this);
    b.flip();
    return b;
}
...
template <typename Block, typename Allocator>
typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::count() const
{
    ...
    typedef value_to_type< no_padding && enough_table_width ?
...
template <typename B, typename A, typename stringT>
void to_string_helper(const mmap_dynamic_bitset<B, A> & b, stringT & s,
                      bool dump_all)
{
    ...
    typedef typename mmap_dynamic_bitset<B, A>::size_type size_type;

    const size_type len = dump_all?
         mmap_dynamic_bitset<B, A>::bits_per_block * b.num_blocks():
         b.size();
    s.assign (len, zero);
...
template <typename B, typename A, typename stringT>
inline void
dump_to_string(const mmap_dynamic_bitset<B, A>& b, stringT& s)
{
...
template <typename Block, typename Allocator>
unsigned long mmap_dynamic_bitset<Block, Allocator>::
to_ulong() const
{
  ...
  if (find_next(ulong_width - 1) != npos)
    throw std::overflow_error("boost::mmap_dynamic_bitset::to_ulong overflow");
...
template <typename Block, typename Allocator>
inline typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::size() const
{
    return m_num_bits;
}
...
template <typename Block, typename Allocator>
inline typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::num_blocks() const
{
    return m_bits.size();
}
...
template <typename Block, typename Allocator>
inline typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::max_size() const
{
...
template <typename Block, typename Allocator>
inline bool mmap_dynamic_bitset<Block, Allocator>::empty() const
{
  return size() == 0;
}

template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::
is_subset_of(const mmap_dynamic_bitset<Block, Allocator>& a) const
{
    assert(size() == a.size());
    for (size_type i = 0; i < num_blocks(); ++i)
...
template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::
is_proper_subset_of(const mmap_dynamic_bitset<Block, Allocator>& a) const
{
    assert(size() == a.size());
...
template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::intersects(const mmap_dynamic_bitset & b) const
{
...
template <typename Block, typename Allocator>
typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::m_do_find_from(size_type first_block) const
{
...
template <typename Block, typename Allocator>
typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::find_first() const
{
...
template <typename Block, typename Allocator>
typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::find_next(size_type pos) const
{
...
template <typename Block, typename Allocator>
inline bool operator!=(const mmap_dynamic_bitset<Block, Allocator>& a,
                       const mmap_dynamic_bitset<Block, Allocator>& b)
{
    return !(a == b);
}
               ...
               const mmap_dynamic_bitset<Block, Allocator>& b)
{
    ...
    typedef typename mmap_dynamic_bitset<Block, Allocator>::size_type size_type;
...
std::ostream&
operator<<(std::ostream& os, const mmap_dynamic_bitset<Block, Alloc>& b)
{
    ...
    if (os.opfx()) {
        ...
        //try
        typedef typename mmap_dynamic_bitset<Block, Alloc>::size_type bitsetsize_type;
...
operator<<(std::basic_ostream<Ch, Tr>& os,
           const mmap_dynamic_bitset<Block, Alloc>& b)
{
...
template <typename Block, typename Alloc>
std::istream&
operator>>(std::istream& is, mmap_dynamic_bitset<Block, Alloc>& b)
{
...
//  the stream's setstate() _cannot_ throw.
    ...
    typedef mmap_dynamic_bitset<Block, Alloc> bitset_type;
...
operator>>(std::basic_istream<Ch, Tr>& is, mmap_dynamic_bitset<Block, Alloc>& b)
{
...
template <typename Block, typename Allocator>
mmap_dynamic_bitset<Block, Allocator>
operator&(const mmap_dynamic_bitset<Block, Allocator>& x,
          const mmap_dynamic_bitset<Block, Allocator>& y)
{
    mmap_dynamic_bitset<Block, Allocator> b(x);
    return b &= y;
}
...
template<typename Block, typename Allocator>
inline void
swap(mmap_dynamic_bitset<Block, Allocator>& left,
     mmap_dynamic_bitset<Block, Allocator>& right) // no throw
{
    left.swap(right);
}
...
template <typename Block, typename Allocator>
inline typename mmap_dynamic_bitset<Block, Allocator>::size_type
mmap_dynamic_bitset<Block, Allocator>::calc_num_blocks(size_type num_bits)
{
...
//
template <typename Block, typename Allocator>
inline Block& mmap_dynamic_bitset<Block, Allocator>::m_highest_block()
{
    return const_cast<Block &>
           (static_cast<const mmap_dynamic_bitset *>(this)->m_highest_block());
}

// gives a const-reference to the highest block
//
template <typename Block, typename Allocator>
inline const Block& mmap_dynamic_bitset<Block, Allocator>::m_highest_block() const
{
...
//
template <typename Block, typename Allocator>
inline void mmap_dynamic_bitset<Block, Allocator>::m_zero_unused_bits()
{
...
template <typename Block, typename Allocator>
bool mmap_dynamic_bitset<Block, Allocator>::m_check_invariants() const
{
    const block_width_type extra_bits = count_extra_bits();
    if (extra_bits > 0) {
